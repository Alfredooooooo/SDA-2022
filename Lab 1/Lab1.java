    ...
    static int getTotalDeletedLetters(int N, char[] x) {
        ...
        for (int i = 0; i<x.length; i++) {
            ...
            if (!"SOFITA".contains(str)) {
                ...
                if (str.equals("S")) {
                    totalS += 1;
                } else if (totalS != 0 && totalO + 1 <= totalS && str.equals("O")) {
                    totalO += 1;
                } else if (totalS != 0  && totalO != 0 && totalF + 1 <= totalO && totalF + 1 <= totalS && str.equals("F")) {
                    totalF += 1;
                } else if (totalS != 0 && totalO != 0 && totalF != 0 && totalI + 1 <= totalF && totalI + 1 <= totalO && totalI + 1 <= totalS && str.equals("I")) {
                    totalI += 1;
                } else if (totalS != 0 && totalO != 0 && totalF != 0 && totalI != 0 && totalT + 1 <= totalI && totalT + 1 <= totalF && totalT + 1 <= totalO && totalT + 1 <= totalS && str.equals("T")) {
                    totalT += 1;
                } else if (totalS != 0 && totalO != 0 && totalF != 0 && totalI != 0 && totalT != 0 && totalA + 1 <= totalT && totalA + 1 <= totalI && totalA + 1 <= totalF && totalA + 1 <= totalO && totalA + 1 <= totalS && str.equals("A")) {
                    totalA += 1;
                    totalA--;
                    totalS--;
                    totalO--;
